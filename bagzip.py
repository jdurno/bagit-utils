# zip up a bagged directory and delete the original

import os
import zipfile


directory = "/TLD/of/contents/to/be/zipped"
...
"""This is a function for zipping an entire directory into a zipfile"""
...
for subdir in subdirs:
	...
	myBagFile = os.path.join(directory, subdir + ".zip")
	
	zipdir(myBagDir,myBagFile,True)
